...
Welcome to the **Orders123 Analytics Project** repository!
...
#### Specifications
- **Data Sources**: Import data from one source systems (ChatGPT generated data) provided as CSV files.
- **Data Quality**: Cleanse and resolve data quality issues prior to analysis.
- **Integration**: No integration required as it is a single source.
